...
const (
	...
	// Custom precompiled contract gas prices

	ConwayGas        uint64 = 500 // Base price for conway operation
	ConwayGasPerCell uint64 = 100 // Per-cell price for conway operation
